...
// One boxed portfolio card: header + either its table or an EmptyState.
  ...
  return (
    <div className="os-section">
      <div className="os-section__header">
        <h3 className="os-section__title" style={{ fontSize: "0.875rem" }}>{title}</h3>
      </div>
        ...
        <TabPanels>
          <TabPanel style={{ padding: 0 }}>
            <div style={{ display: "grid", gap: "1.5rem", marginTop: "1rem" }}>
              <PortfolioCard
                title="Prefect Appointments"
                isEmpty={!prefects || prefects.length === 0}
                emptyTitle="No prefect appointments"
                emptyDescription="Record of appointments will show up here."
              >
              ...
              <PortfolioCard
                ...
                isEmpty={!societies || societies.length === 0}
                emptyTitle="No society memberships"
                emptyDescription="Your clubs and societies memberships will show up here."
              >
                <table className="os-table">
                  <thead>
          ...
          <TabPanel style={{ padding: 0 }}>
            <div style={{ marginTop: "1rem" }}>
              <PortfolioCard
                ...
                emptyDescription="Your participation in sports or clubs will show up here."
              >
                <table className="os-table">
                  <thead>
          ...
          <TabPanel style={{ padding: 0 }}>
            <div style={{ display: "grid", gap: "1.5rem", marginTop: "1rem" }}>
              <PortfolioCard
                ...
                isEmpty={!leadership || leadership.length === 0}
                emptyTitle="No leadership roles"
                emptyDescription="Class monitor or other leadership roles will show up here."
              >
                <table className="os-table">
                  <thead>
              ...
              <PortfolioCard
                ...
                isEmpty={!awards || awards.length === 0}
                emptyTitle="No awards logged"
                emptyDescription="Your awards and certifications will show up here."
              >
                <table className="os-table">
                  <thead>
          ...
          <TabPanel style={{ padding: 0 }}>
            <div style={{ marginTop: "1rem" }}>
              <PortfolioCard
                ...
                isEmpty={!discipline || discipline.length === 0}
                emptyTitle="No disciplinary records"
                emptyDescription="Your disciplinary status is clear."
              >
                <table className="os-table">
                  <thead>
