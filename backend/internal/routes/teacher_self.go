...
func RegisterTeacherSelfRoutes(teacher *gin.RouterGroup, pool *pgxpool.Pool, timetableService *timetablemodule.Reader, positionService *leadershipmodule.Service, societyService *studentleadershipmodule.Service, dashboardService *dashboardmodule.Service) {
